---
title: deleteByDeleteWithFilter
---

import { Badge } from '@astrojs/starlight/components';
import { Tabs, TabItem } from '@astrojs/starlight/components';

<!-- 1379e368-1d48-808e-bb88-c41168c50d7c -->
...
<Badge text="DELETE" variant="danger" /> <Badge text="POST" variant="note" />

<br/><br/>

TODO: description. <a href="https://www.notion.so/deleteByDeleteWithFilter-1379e3681d48808ebb88c41168c50d7c">https://www.notion.so/deleteByDeleteWithFilter-1379e3681d48808ebb88c41168c50d7c</a>

## Global rules

<details><summary>Asyncability</summary>
<Tabs><TabItem label="Request">
|  |  |
| --- | --- |
...
| Header | <ul><li>`WebHook-Error-Callback` <Badge text="MAY" variant="success" size="small" /> **be** webhook URL **if** if the client is able to specify a callback endpoint (a “webhook”) <br/><em>Webhook callbacks</em></li></ul> |</TabItem>
...
| Body | <ul><li>`error` <Badge text="MUST" variant="danger" size="small" /> **exists** **if** if the operation endpoint is ready but the operation was failed <br/><em>Recurrent polling</em></li></ul> |</TabItem></Tabs></details>
<details><summary>PreferHandling</summary>
<Tabs><TabItem label="Request">
|  |  |
| --- | --- |
...
| Header | <ul><li>`Prefer` <Badge text="SHOULD" variant="caution" size="small" /> **be** handling=strict **if** in case of the client is strict to optional validation rules </li></ul> |</TabItem>
</Tabs></details>
<details><summary>PreferReturn</summary>
<Tabs><TabItem label="Request">
|  |  |
| --- | --- |
...
| Header | <ul><li>`Prefer` <Badge text="SHOULD" variant="caution" size="small" /> **be** return=representation **if** if the client prefer the result document(s) which the operation was applied <br/><em>Default if ommited</em></li></ul> |</TabItem>
<TabItem label="Response">
|  |  |
| --- | --- |
...
| Header | <ul><li>`Location` <Badge text="MUST" variant="danger" size="small" /> **be** getByGetWithId(id) **if** if the client sent Prefer: return=minimal </li></ul> |</TabItem></Tabs></details>
...
| Body | <ul><li>`[other]` <Badge text="MAY" variant="success" size="small" /> **be** help info  </li></ul> |</TabItem></Tabs></details>
<details><summary>EJSON</summary>
<Tabs><TabItem label="Request">
|  |  |
| --- | --- |
| Header | <ul><li>`Content-Type` <Badge text="SHOULD" variant="caution" size="small" /> **be** application/vnd.ejson+json  </li></ul> |
| Body | <ul><li>`` <Badge text="SHOULD" variant="caution" size="small" /> **be** EJSON serialized  </li></ul> |</TabItem>
<TabItem label="Response">
|  |  |
| --- | --- |
| Body | <ul><li>`` <Badge text="SHOULD" variant="caution" size="small" /> **be** EJSON serialized  </li></ul> |
| Header | <ul><li>`Content-Type` <Badge text="SHOULD" variant="caution" size="small" /> **be** application/vnd.ejson+json  </li></ul> |</TabItem></Tabs></details>
<details><summary>NoEnvelopes</summary>
<Tabs><TabItem label="Request">
|  |  |
| --- | --- |
| Body | <ul><li>`` <Badge text="MUST" variant="danger" size="small" /> **be** unenveloped resource  </li></ul> |</TabItem>
<TabItem label="Response">
|  |  |
| --- | --- |
| Body | <ul><li>`` <Badge text="MUST" variant="danger" size="small" /> **be** unenveloped resource  </li></ul> |</TabItem></Tabs></details>
<details><summary>X-Request-Id</summary>
<Tabs>
<TabItem label="Response">
|  |  |
| --- | --- |
| Header | <ul><li>`X-Request-Id` <Badge text="SHOULD" variant="caution" size="small" /> **be** new uuid-hex   <br/><em>a fresh new uuid-hex generated by the API server</em></li></ul> |</TabItem></Tabs></details>
<details><summary>ContentTypes</summary>
<Tabs><TabItem label="Request">
|  |  |
| --- | --- |
| Header | <ul><li>`Accept` <Badge text="MUST" variant="danger" size="small" /> **exists**  </li></ul> |</TabItem>
<TabItem label="Response">
|  |  |
| --- | --- |
| Header | <ul><li>`Content-Type` <Badge text="MUST" variant="danger" size="small" /> **exists**  </li></ul> |
| Status | <ul><li>`code` <Badge text="MUST" variant="danger" size="small" /> **be** 406 **if** if the Content-Type not matches the Accept request header </li></ul> |</TabItem></Tabs></details>

## Operation rules

<details><summary>X-Matched-Count</summary>
<Tabs>
</Tabs></details>
<details><summary>If-Match</summary>
<Tabs>
</Tabs></details>
